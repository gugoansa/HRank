...
export class FramePage {
  // ... (propiedades solo declaradas, sin valor inicial)
  private readonly iFrameContext: FrameLocator;
  private readonly editorBody: Locator;
  private readonly iFrameUrl: string = 'https://the-internet.herokuapp.com/iframe';
...
*/
  ...
  async mapsToIFramePage():Promise<void>{
  ...
  //Para obtener el texto y verificarlo.
     ...
     */
  async getIFrameTextContent():Promise<string>{
